...
> **⚠️ Warning:** This is the legacy documentation for Jumpy, before the Bevy rewrite was merged. It
> is no longer up-to-date, but it still has some useful thoughts, and some of it may still be good
> to migrate to the new documentation.
>
> The latest documentation site can be found [here](https://fishfolk.github.io/jumpy/book/).
